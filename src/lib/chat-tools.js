    ...
    return [
        ...
        },
        {
            ...
            parameters: {
                type: "object",
                properties: {
                    threshold: { type: "integer", minimum: 0, description: "Stock level to consider 'low'. Defaults to 10." },
                },
        ...
        },
        {
            ...
            parameters: {
                type: "object",
                properties: {
                    days: { type: "integer", minimum: 1, maximum: 90, description: "How many days back to look. Defaults to 30, max 90." },
                },
                additionalProperties: false,
            },
            run: async ({ days }) => {
